...
class _TeacherLoginScreenState extends State<TeacherLoginScreen> {
  ...
  void initState() {
    ...
    // Always set teacher mode to true when on the teacher login screen
                  ...
                  onTap: _loginController.isLoading.value 
                    ...
                    : () async {
                        if (_formKey.currentState!.validate()) {
                          ...
                          await _loginController.attemptLogin('teachers', context);
                        }
                      },
                )),
                SizedBox(height: 20.h),
  ...
  Future<bool> _checkDynamoDbConnection() async {
    try {
      final dbService = DBService();
      return await dbService.initializeTables();
    } catch (e) {
      print('Error checking DynamoDB connection: $e');
      return false;
    }
  }
}
